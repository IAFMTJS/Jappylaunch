...
export const quizWords: QuizWord[] = [
  ...
  { japanese: 'な', english: 'na', category: 'hiragana', difficulty: 'easy', hint: 'N sound + a', romaji: 'na' },
  { japanese: 'に', english: 'ni', category: 'hiragana', difficulty: 'easy', hint: 'N sound + i', romaji: 'ni' },
  { japanese: 'ぬ', english: 'nu', category: 'hiragana', difficulty: 'easy', hint: 'N sound + u', romaji: 'nu' },
  { japanese: 'ね', english: 'ne', category: 'hiragana', difficulty: 'easy', hint: 'N sound + e', romaji: 'ne' },
  { japanese: 'の', english: 'no', category: 'hiragana', difficulty: 'easy', hint: 'N sound + o', romaji: 'no' },
  { japanese: 'は', english: 'ha', category: 'hiragana', difficulty: 'easy', hint: 'H sound + a', romaji: 'ha' },
  { japanese: 'ひ', english: 'hi', category: 'hiragana', difficulty: 'easy', hint: 'H sound + i', romaji: 'hi' },
  { japanese: 'ふ', english: 'fu', category: 'hiragana', difficulty: 'easy', hint: 'H sound + u', romaji: 'fu' },
  { japanese: 'へ', english: 'he', category: 'hiragana', difficulty: 'easy', hint: 'H sound + e', romaji: 'he' },
  { japanese: 'ほ', english: 'ho', category: 'hiragana', difficulty: 'easy', hint: 'H sound + o', romaji: 'ho' },
  { japanese: 'ま', english: 'ma', category: 'hiragana', difficulty: 'easy', hint: 'M sound + a', romaji: 'ma' },
  { japanese: 'み', english: 'mi', category: 'hiragana', difficulty: 'easy', hint: 'M sound + i', romaji: 'mi' },
  { japanese: 'む', english: 'mu', category: 'hiragana', difficulty: 'easy', hint: 'M sound + u', romaji: 'mu' },
  { japanese: 'め', english: 'me', category: 'hiragana', difficulty: 'easy', hint: 'M sound + e', romaji: 'me' },
  { japanese: 'も', english: 'mo', category: 'hiragana', difficulty: 'easy', hint: 'M sound + o', romaji: 'mo' },
  { japanese: 'や', english: 'ya', category: 'hiragana', difficulty: 'easy', hint: 'Y sound + a', romaji: 'ya' },
  { japanese: 'ゆ', english: 'yu', category: 'hiragana', difficulty: 'easy', hint: 'Y sound + u', romaji: 'yu' },
  { japanese: 'よ', english: 'yo', category: 'hiragana', difficulty: 'easy', hint: 'Y sound + o', romaji: 'yo' },
  { japanese: 'ら', english: 'ra', category: 'hiragana', difficulty: 'easy', hint: 'R sound + a', romaji: 'ra' },
  { japanese: 'り', english: 'ri', category: 'hiragana', difficulty: 'easy', hint: 'R sound + i', romaji: 'ri' },
  { japanese: 'る', english: 'ru', category: 'hiragana', difficulty: 'easy', hint: 'R sound + u', romaji: 'ru' },
  { japanese: 'れ', english: 're', category: 'hiragana', difficulty: 'easy', hint: 'R sound + e', romaji: 're' },
  { japanese: 'ろ', english: 'ro', category: 'hiragana', difficulty: 'easy', hint: 'R sound + o', romaji: 'ro' },
  { japanese: 'わ', english: 'wa', category: 'hiragana', difficulty: 'easy', hint: 'W sound + a', romaji: 'wa' },
  { japanese: 'を', english: 'wo', category: 'hiragana', difficulty: 'easy', hint: 'W sound + o', romaji: 'wo' },
  { japanese: 'ん', english: 'n', category: 'hiragana', difficulty: 'easy', hint: 'N sound', romaji: 'n' },
  ...
  { japanese: 'ナ', english: 'na', category: 'katakana', difficulty: 'easy', hint: 'N sound + a', romaji: 'na' },
  { japanese: 'ニ', english: 'ni', category: 'katakana', difficulty: 'easy', hint: 'N sound + i', romaji: 'ni' },
  { japanese: 'ヌ', english: 'nu', category: 'katakana', difficulty: 'easy', hint: 'N sound + u', romaji: 'nu' },
  { japanese: 'ネ', english: 'ne', category: 'katakana', difficulty: 'easy', hint: 'N sound + e', romaji: 'ne' },
  { japanese: 'ノ', english: 'no', category: 'katakana', difficulty: 'easy', hint: 'N sound + o', romaji: 'no' },
  { japanese: 'ハ', english: 'ha', category: 'katakana', difficulty: 'easy', hint: 'H sound + a', romaji: 'ha' },
  { japanese: 'ヒ', english: 'hi', category: 'katakana', difficulty: 'easy', hint: 'H sound + i', romaji: 'hi' },
  { japanese: 'フ', english: 'fu', category: 'katakana', difficulty: 'easy', hint: 'H sound + u', romaji: 'fu' },
  { japanese: 'ヘ', english: 'he', category: 'katakana', difficulty: 'easy', hint: 'H sound + e', romaji: 'he' },
  { japanese: 'ホ', english: 'ho', category: 'katakana', difficulty: 'easy', hint: 'H sound + o', romaji: 'ho' },
  { japanese: 'マ', english: 'ma', category: 'katakana', difficulty: 'easy', hint: 'M sound + a', romaji: 'ma' },
  { japanese: 'ミ', english: 'mi', category: 'katakana', difficulty: 'easy', hint: 'M sound + i', romaji: 'mi' },
  { japanese: 'ム', english: 'mu', category: 'katakana', difficulty: 'easy', hint: 'M sound + u', romaji: 'mu' },
  { japanese: 'メ', english: 'me', category: 'katakana', difficulty: 'easy', hint: 'M sound + e', romaji: 'me' },
  { japanese: 'モ', english: 'mo', category: 'katakana', difficulty: 'easy', hint: 'M sound + o', romaji: 'mo' },
  { japanese: 'ヤ', english: 'ya', category: 'katakana', difficulty: 'easy', hint: 'Y sound + a', romaji: 'ya' },
  { japanese: 'ユ', english: 'yu', category: 'katakana', difficulty: 'easy', hint: 'Y sound + u', romaji: 'yu' },
  { japanese: 'ヨ', english: 'yo', category: 'katakana', difficulty: 'easy', hint: 'Y sound + o', romaji: 'yo' },
  { japanese: 'ラ', english: 'ra', category: 'katakana', difficulty: 'easy', hint: 'R sound + a', romaji: 'ra' },
  { japanese: 'リ', english: 'ri', category: 'katakana', difficulty: 'easy', hint: 'R sound + i', romaji: 'ri' },
  { japanese: 'ル', english: 'ru', category: 'katakana', difficulty: 'easy', hint: 'R sound + u', romaji: 'ru' },
  { japanese: 'レ', english: 're', category: 'katakana', difficulty: 'easy', hint: 'R sound + e', romaji: 're' },
  { japanese: 'ロ', english: 'ro', category: 'katakana', difficulty: 'easy', hint: 'R sound + o', romaji: 'ro' },
  { japanese: 'ワ', english: 'wa', category: 'katakana', difficulty: 'easy', hint: 'W sound + a', romaji: 'wa' },
  { japanese: 'ヲ', english: 'wo', category: 'katakana', difficulty: 'easy', hint: 'W sound + o', romaji: 'wo' },
  { japanese: 'ン', english: 'n', category: 'katakana', difficulty: 'easy', hint: 'N sound', romaji: 'n' }
]; 